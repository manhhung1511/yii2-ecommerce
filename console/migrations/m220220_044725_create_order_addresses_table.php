 ...
 * - `{{%orders}}`
 */
class m220220_044725_create_order_addresses_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('{{%order_addresses}}', [
            ...
            'zipcode' => $this->string(45)->notNull(),
        ]);

        $this->addPrimaryKey('PK_order_address','{{%order_addresses}}', 'order_id');
